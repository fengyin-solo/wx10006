<template>
  <section class="page" data-module="tally">
    <header class="page-head">
      <div>
        <h2>理货作业管理</h2>
        <p class="page-desc">维护理货单，围绕理货编号、船舶航次、理货类型、计划箱数做登记、筛选与状态流转。</p>
      </div>
...
const columns = ["理货编号", "船舶航次", "理货类型", "计划箱数", "实际箱数", "残损箱数", "理货长", "理货状态"]
const actions = ["开始理货", "签认交接", "标记争议"]
const statuses = ["待理货", "理货中", "已签认", "有争议"]
const stats = [{"label": "待理货单", "value": 0}, {"label": "理货中单", "value": 0}, {"label": "今日签认", "value": 0}]
